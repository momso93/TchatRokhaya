...
import com.example.momo.messagerieapp.core.Chat;
import com.example.momo.messagerieapp.core.ChatService;
import com.example.momo.messagerieapp.core.GroupChatImpl;
import com.example.momo.messagerieapp.core.PrivateChatImpl;
import com.example.momo.messagerieapp.ui.adapters.ChatAdapter;
    ...
    private void sendChatMessage(String messageText) {
      ...
      //  if (isOnLine()){
       ...
       /* }
            ...
            qbEvent.setMessage(messageText);
            ...
            QBMessages.createEvent(qbEvent, new QBEntityCallback<QBEvent>() {
                ...
                public void onSuccess(QBEvent qbEvent, Bundle bundle) {
                    Toast.makeText(ChatActivity.this, "Push Bien Envoyé", Toast.LENGTH_SHORT).show();
