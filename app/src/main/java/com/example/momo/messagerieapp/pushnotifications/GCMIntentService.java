package com.example.momo.messagerieapp.pushnotifications;
...
import com.example.momo.messagerieapp.ui.activities.DialogsActivity;
...
public class GCMIntentService extends IntentService {
    ...
    // a GCM message.
    public void processNotification(String type, Bundle extras) {
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this).setSmallIcon(
                R.drawable.marodi).setContentTitle(Consts.GCM_NOTIFICATION).setStyle(
                new NotificationCompat.BigTextStyle().bigText(messageValue))
